...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_openFile(
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_openByteArray(
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_openDirectByteBuffer(
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_openStream(
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_openFd(
...
JNIEXPORT jboolean JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_reset(
...
JNIEXPORT void JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_setSpeedFactor(
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_renderFrame(
...
JNIEXPORT void JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_free(JNIEnv * env,
...
JNIEXPORT jstring JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_getComment(
		JNIEnv * env, jclass class, jobject gifInfo) {
	if (gifInfo == NULL)
		return NULL ;
	GifInfo* info = (GifInfo*) gifInfo;
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_getLoopCount(
		JNIEnv * env, jclass class, jobject gifInfo) {
	if (gifInfo == NULL)
		return 0;
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_getDuration(
		JNIEnv * env, jclass class, jobject gifInfo) {
	GifInfo* info = (GifInfo*) gifInfo;
	if (info == NULL)
		return 0;
...
JNIEXPORT jint JNICALL Java_com_yugy_qingbo_ui_component_gif_GifDrawable_getCurrentPosition(
		JNIEnv * env, jclass class, jobject gifInfo) {
	GifInfo* info = (GifInfo*) gifInfo;
	if (info == NULL)
		return 0;
