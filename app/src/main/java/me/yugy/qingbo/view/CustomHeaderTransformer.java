...
public class CustomHeaderTransformer extends HeaderTransformer {
    ...
    public CustomHeaderTransformer() {
...
//        }
        ...
        if (mHeaderProgressBar != null) {
            ...
            mHeaderProgressBar.setIndeterminateDrawable(
                    new SmoothProgressDrawable.Builder(mHeaderProgressBar.getContext())
                            .colors(new int[]{
                                mHeaderProgressBar.getContext().getResources().getColor(R.color.gplus_color_1),
                                mHeaderProgressBar.getContext().getResources().getColor(R.color.gplus_color_2),
                                mHeaderProgressBar.getContext().getResources().getColor(R.color.gplus_color_3),
                                mHeaderProgressBar.getContext().getResources().getColor(R.color.gplus_color_4),
                            })
    ...
    Drawable getActionBarBackground(Context context) {
    ...
    int getActionBarTitleStyle(Context context) {
