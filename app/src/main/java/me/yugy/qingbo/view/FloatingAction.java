...
public class FloatingAction {
    ...
    private FloatingAction(Builder builder) {
        ...
        final View parent = mActivity.getLayoutInflater().inflate(R.layout.view_floating_button, mViewGroup, true);
        mView = (ImageButton) parent.findViewById(R.id.floating_btn);
    ...
    public static class Builder {
        ...
        public Builder icon(int drawableResId) {
    ...
    private static void checkResId(int resId, String msg) {
        if (resId < 0) {
